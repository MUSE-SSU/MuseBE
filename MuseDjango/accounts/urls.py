...
urlpatterns = [
    ...
    path(
        "check/nickname/", views.check_nickname_overlap, name="check-nickname-overlap"
    ),
    path("update/", views.update_userinfo, name="update-userinfo"),
    path("follow/", views.follow, name="follow"),
    path("my-page/<str:nickname>/", views.my_page, name="my-page"),
    path(
        "my-page/owner/post/<str:nickname>/",
        views.owner_post,
        name="my-page-owner-post",
    ),
    path(
        "my-page/owner/liked-post/<str:nickname>/",
        views.owner_liked_post,
        name="owner-liked-post",
    ),
