...
urlpatterns = [
    ...
    path("display/contest/", views.post_display_contest_topic, name="display_post_contest_topic"),
    ...
    path("comment/update/<int:comment_idx>/", views.comment_update, name="update_comment"),
    path(
